const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://codogrupo22.pythonanywhere.com/profesionales", // Retorna todos los registro de la tabla productos
        profesionales:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        fetchData(url) {
            // Acá se consume la Api  /profesionales
            fetch(url)
        ...
        eliminar(id) {
            ...
            const url = 'https://codogrupo22.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
